...
public class LogUtils {
    ...
    public static void i(String msg) {
        if (isDebug)
            Log.i(TAG, Utils.isEmpty(msg));
    }

    public static void d(String msg) {
        if (isDebug)
            Log.d(TAG, Utils.isEmpty(msg));
    }

    public static void e(String msg) {
        if (isDebug)
            Log.e(TAG, Utils.isEmpty(msg));
    }

    public static void e(String msg, Exception e) {
        if (isDebug)
            Log.w(TAG, Utils.isEmpty(msg), e);
    }
    ...
    public static void v(String msg) {
        if (isDebug)
            Log.v(TAG, Utils.isEmpty(msg));
    }

    public static void w(String msg) {
        if (isDebug)
            Log.w(TAG, Utils.isEmpty(msg));
    }
