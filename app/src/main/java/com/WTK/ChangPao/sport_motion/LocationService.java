package com.WTK.ChangPao.sport_motion;
...
import com.WTK.ChangPao.sport_motion.servicecode.impl.RecordServiceImpl;
...
//    private List<LatLng> mSportLatLngs = new LinkedList<>();
    ...
    private void initLocationOption() {
        ...
        mOption.setSensorEnable(true);//可选，设置是否使用传感器。默认是false              这这这这这这这这这这这这这这这这这这这这这这这这这这这这这这这这
